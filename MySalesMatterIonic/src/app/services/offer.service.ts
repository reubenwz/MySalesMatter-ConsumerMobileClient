...
export class OfferService {
  ...
  updateOffer(offerToUpdate: Offer): Observable<any> {
    let updateOfferReq: UpdateOfferReq = new UpdateOfferReq(
      this.sessionService.getEmail(),
      this.sessionService.getPassword(),
      offerToUpdate
    );
    ...
    return this.httpClient
      .post<any>(this.baseUrl, updateOfferReq, httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  createNewOffer(
    ...
    let createOfferReq: CreateOfferReq = new CreateOfferReq(
      this.sessionService.getEmail(),
      this.sessionService.getPassword(),
      totalPrice,
      offerDate,
    ...
    return this.httpClient
      .put<Offer>(this.baseUrl, createOfferReq, httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  getPurchaseOffersByUserId(): Observable<Offer[]> {
    return this.httpClient
      .get<Offer[]>(
        this.baseUrl +
